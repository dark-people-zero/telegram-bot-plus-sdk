...
namespace DarkPeople\TelegramBot\Facades;

use DarkPeople\TelegramBot\BotsManagerPlus;
use Illuminate\Support\Facades\Facade;

/**
 * @see \DarkPeople\TelegramBot\BotsManagerPlus
 *
 * @method static \DarkPeople\TelegramBot\BotsManagerPlus setContainer(\Psr\Container\ContainerInterface $container)
 ...
 * @method static \DarkPeople\TelegramBot\BotsManagerPlus disconnect(?string $name = null)
 ...
 * @method static \DarkPeople\TelegramBot\BotsManagerPlus setDefaultBot(string $name)
 * @method static array getBots()
 * @method static array parseBotCommands(array $commands)
 * @method static void handler(\Illuminate\Http\Request $request)
 *
 ...
 */
final class TelegramBot extends Facade
{
    /**
